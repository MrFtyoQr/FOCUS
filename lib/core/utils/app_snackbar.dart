...
/// SnackBars alineados a la paleta pastel (sin primarios Material ni blanco/negro
/// puros en primer plano). Mantiene [SnackBarBehavior.floating] para la UX previa.
abstract final class AppSnackBar {
  ...
  static SnackBar exito(
    ...
    return SnackBar(
      ...
      /// Con acción (p. ej. «Deshacer»), Material 3 pone por defecto `persist: true`
      /// y el SnackBar **no** se oculta solo; forzamos cierre automático tras [duration].
      persist: false,
