...
/// Alias con el nombre de dominio usado en diseño (mismo enum que [ActivityStatus]).
typedef EstadoActividad = ActivityStatus;
...
abstract final class EstadoActividadColors {
  ...
  static Color forEstadoConContexto(
...
/// API existente en pantallas y widgets: mismo comportamiento que [EstadoActividadColors.forEstado].
abstract final class ActivityStatusColors {
  static Color forStatus(
    ActivityStatus status, {
    required Brightness brightness,
  }) {
    return EstadoActividadColors.forEstado(status, brightness: brightness);
  }
}
