...
class MainShell extends StatelessWidget {
  ...
  static const _tabs = [
    ...
    (path: '/stats',    label: 'Stats',        icon: Icons.trending_up_rounded),
  ...
  Widget build(BuildContext context) {
    ...
    if (idx < 0) {
      if (location.startsWith('/projects')) idx = 2;
      else if (location.startsWith('/team')) idx = 4;
      else idx = 0;
    }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        decoration: const BoxDecoration(border: Border(top: BorderSide(color: AppColors.surfaceBorder, width: 0.5))),
